...
#include "backends/bmv2/dpdk_switch/midend.h"
#include "backends/bmv2/dpdk_switch/dpdkSwitch.h"
#include "backends/bmv2/dpdk_switch/version.h"
...
int main(int argc, char *const argv[]) {
    ...
    BMV2::DpdkSwitchMidEnd midEnd(options);
    ...
    auto backend = new BMV2::DpdkSwitchBackend(options, &midEnd.refMap,
